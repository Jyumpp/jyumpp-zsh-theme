# Generated by Powerlevel10k configuration wizard on 2020-05-08 at 01:49 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context
    vcs                 # os identifier
    dir                     # current directory                     # git status
...
#    context                 # user@hostname
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%3f'     # default foreground
      local      clean='%3F'   # green foreground
      local   modified='%3F'  # yellow foreground
      local  untracked='%3F'   # blue foreground
      local conflicted='%3F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%3F'  # grey foreground
      local      clean='%3F'  # grey foreground
      local   modified='%3F'  # grey foreground
      local  untracked='%3F'  # grey foreground
      local conflicted='%3F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%11F%n%231F@%14F%m%231F:'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%11F%n%231F@%14F%m%231F:'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%11F%n%231F@%14F%m%231F:'
